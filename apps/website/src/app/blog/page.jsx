...
const BlogCard = ({ post }) => {
    ...
    return (
        <div className="group relative w-full h-[360px] sm:h-[380px] rounded-3xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-500 cursor-pointer bg-muted">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-zinc-900 px-5 py-4 z-20 flex flex-col gap-2.5">
                ...
                {/* Author defaults to SkillYards Team as it's not in our query */}
