...
export default function SuryanshHero() {
    ...
    useEffect(() => {
        fetch("https://admin.skillyards.in/api/team/leaders/suryanshupadhyay")
            .then((res) => res.json())
            .then((json) => {
        ...
        <section className="relative bg-linear-to-b from-white via-zinc-50 to-zinc-100 dark:from-neutral-950 dark:via-neutral-900 dark:to-black py-24 transition-colors duration-500">
            <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    {/* Breadcrumbs */}
                    <div className="mb-8">
                        <Breadcrumbs className="text-sm" currentLabel="Suryansh Upadhyay" />
                    </div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6 max-w-2xl">
                        {/* Optional bio */}
                        Suryansh Upadhyay is the dynamic CEO of SkillYards, ensuring impactful learning experiences through operational excellence.
                    </p>
